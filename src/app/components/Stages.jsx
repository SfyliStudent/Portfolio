...
function Stages () {
    ...
    return (
        ...
        <br />
        <br />
        <p>Dans le cadre de mon bts en services informatiques aux organisations, et en spécialité &quot;solutions logicielles et applications
       ...
       <br />
        <p>Les 5 premières semaines de stages je les ai effectués en distance puisque les activités de l'entreprise le permettait, nous communiquions
            ...
            <br />
            <p>Il m'a été confié le développement d'une application, dont le but était de créer un générateur de signature.
            ...
            <br />
        <p> Pour les 5 dernières semaines de stages. Je me suis rendu directement sur place à 
            Riyad pour effectuer mon deuxième stage.
            </p>
            <br />
            <h3 className="text-xl font-bold text-white my-2">Ma mission</h3>
            <br />
            <p>Le but de ce second stage était centralisé sur le back-end. Plusieurs tâches m'ont été confiés.
            ...
            <br />
            <p>J'ai effectué ces 10 semaines de stages en anglais.</p>
