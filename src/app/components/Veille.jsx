    ...
    return (
       <div>
        ...
        <div class="flex items-center justify-center min-h-screen">
          ...
          <br />
          <p>La veille technologique consiste à s&apos;informer de façon systématique sur les techniques les plus récentes et surtout sur leur mise à disposition commerciales.
      ...
      <br />
      <p>L&apos;intelligence artificielle (IA) est un domaine de l&apos;informatique qui vise à créer des systèmes informatiques capables de réaliser des tâches qui nécessitent normalement l&apos;intelligence humaine, telles que la perception, le raisonnement, 
      ...
      <br />
      <p>Tous ces événements ont marqué des avancées significatives dans le domaine de l'IA, contribuant à la progression de la recherche et du développement de technologies d'IA plus avancées.</p>
      <br />
      <h5 className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">Ma vielle technologique</h5>
    <br />
      <p>Dans le cadre de ma veille technologique, je vais utiliser un outil qui utilise les flux RSS. L&apos;outil en question est Feedly. Il permet de centraliser tous les flux RSS que vous souhaitez.</p>
      </div>
